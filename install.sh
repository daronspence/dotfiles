...
/usr/local/bin/composer global require laravel/installer laravel/valet tightenco/lambo squizlabs/php_codesniffer wp-coding-standards/wpcs beyondcode/expose
